# Foundations & Non-Governmental Funders — Registry

Philanthropic and non-profit funders of pandemic preparedness, epidemic-response vaccine/therapeutic R&D, biosecurity, and infectious-disease research. One markdown file per entity covering **programmes/initiatives** and **grantees/awardees**.

> **Scope note:** bounded to pandemic / epidemic / biosecurity / infectious-disease work and to *notable or major* grantees. Full grant databases (e.g. Gates makes thousands of grants) are summarised to the largest and most representative, with sources.

| # | Funder | Base | Why relevant | File | Status |
|---|---|---|---|---|---|
| 1 | CEPI | Norway/global | Coalition for Epidemic Preparedness Innovations; vaccine R&D, 100 Days Mission | [cepi.md](cepi.md) | ✅ |
